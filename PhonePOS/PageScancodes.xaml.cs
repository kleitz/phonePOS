...
namespace PhonePOS
{
    public partial class PageScancodes : PhoneApplicationPage
    {
        public PhotoCamera _phoneCamera;
        public IBarcodeReader _barcodeReader;
        public DispatcherTimer _scanTimer;
        public WriteableBitmap _previewBuffer;
        
        public PageScancodes()
        {
            InitializeComponent();
        }
